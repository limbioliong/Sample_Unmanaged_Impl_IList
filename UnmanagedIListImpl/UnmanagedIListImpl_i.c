...
MIDL_DEFINE_GUID(IID, IID__Array,0x2B67CECE,0x71C3,0x36A9,0xA1,0x36,0x92,0x5C,0xCC,0x19,0x35,0xA8);


MIDL_DEFINE_GUID(IID, IID_ICollection,0xDE8DB6F8,0xD101,0x3A92,0x8D,0x1C,0xE7,0x2E,0x5F,0x10,0xE9,0x92);


MIDL_DEFINE_GUID(IID, IID_IEnumerable,0x496B0ABE,0xCDEE,0x11D3,0x88,0xE8,0x00,0x90,0x27,0x54,0xC4,0x3A);
